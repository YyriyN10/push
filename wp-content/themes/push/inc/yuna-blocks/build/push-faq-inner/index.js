...
/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./editor.scss */ "./src/push-faq-inner/editor.scss");
...
function Edit({
  ...
  const hasInner = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_4__.useSelect)(select => {
  ...
  const [migrated, setMigrated] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_5__.useState)(false);
  const migrateLegacyToInnerBlocks = () => {
    if (!answer) return;
    const blocks = (0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_6__.rawHandler)({
      HTML: answer
    }) || [];
    replaceInnerBlocks(clientId, blocks, false);
    setAttributes({
      answer: ''
    }); // очистити легасі, щоб контент не дублювався
    setMigrated(true);
  };
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, !!answer && !hasInner && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.Notice, {
    status: "info",
    isDismissible: false
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Виявлено старий текст відповіді. Конвертувати у параграфи/списки?', 'yuna'), ' ', (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.Button, {
    variant: "primary",
    onClick: migrateLegacyToInnerBlocks
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Конвертувати', 'yuna'))), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...blockProps
    ...
    template: [['core/paragraph', {
      placeholder: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Текст відповіді…', 'yuna')
    }]],
    templateLock: false,
    orientation: "vertical",
    renderAppender: _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.InnerBlocks.ButtonBlockAppender
  }))), migrated && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.Notice, {
    status: "success",
    onRemove: () => setMigrated(false)
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Готово! Текст сконвертовано у внутрішні блоки.', 'yuna')));
}

/***/ }),

/***/ "./src/push-faq-inner/index.js":
/*!*************************************!*\
  !*** ./src/push-faq-inner/index.js ***!
  \*************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @wordpress/block-editor */ "@wordpress/block-editor");
/* harmony import */ var _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./style.scss */ "./src/push-faq-inner/style.scss");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./edit */ "./src/push-faq-inner/edit.js");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./block.json */ "./src/push-faq-inner/block.json");
...
/***/ "./src/push-faq-inner/editor.scss":
/*!****************************************!*\
  !*** ./src/push-faq-inner/editor.scss ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/push-faq-inner/block.json":
/*!***************************************!*\
  !*** ./src/push-faq-inner/block.json ***!
  \***************************************/
/***/ ((module) => {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"push-blocks/push-faq-inner","version":"0.1.0","title":"Внутрішня картка","category":"yuna-inner-block-category","icon":"dashicons-block-default","description":"Внутрішня картка","example":{},"attributes":{"itemQuestion":{"type":"string"},"answer":{"type":"string","default":""},"blockIndex":{"type":"number","default":0}},"supports":{"color":{"background":true,"text":true},"html":false},"parent":["push-blocks/push-faq"],"textdomain":"push","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css","render":"file:./render.php"}');
...
/******/ 		var installedChunks = {
/******/ 			"push-faq-inner/index": 0,
/******/ 			"push-faq-inner/style-index": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["push-faq-inner/style-index"], () => (__webpack_require__("./src/push-faq-inner/index.js")))
