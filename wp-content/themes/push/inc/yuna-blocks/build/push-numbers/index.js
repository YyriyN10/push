...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./block.json */ "./src/push-numbers/block.json");
...
function Edit({
  ...
  //Inner block
  const cardTemplate = [['push-blocks/push-numbers-inner', {}]];
  const ALLOWED_BLOCKS = ['push-blocks/push-numbers-inner'];
...
/* harmony import */ var _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @wordpress/block-editor */ "@wordpress/block-editor");
/* harmony import */ var _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./style.scss */ "./src/push-numbers/style.scss");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./edit */ "./src/push-numbers/edit.js");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./block.json */ "./src/push-numbers/block.json");
...
/***/ "./src/push-numbers/block.json":
/*!*************************************!*\
  !*** ./src/push-numbers/block.json ***!
  \*************************************/
/***/ ((module) => {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"push-blocks/push-numbers","version":"0.1.0","title":"Цифри про нас","icon":"performance","category":"yuna-block-category","description":"Цифри про нас","example":{},"attributes":{"anchorId":{"type":"string"},"topIndent":{"enum":["indent-top-big","indent-top-small"],"default":"indent-top-big","type":"string"},"bottomIndent":{"enum":["indent-bottom-big","indent-bottom-small"],"default":"indent-bottom-big","type":"string"}},"supports":{"color":{"background":true,"text":true,"heading":true,"gradients":true},"html":false},"textdomain":"push","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css","render":"file:./render.php"}');
...
/******/ 		var installedChunks = {
/******/ 			"push-numbers/index": 0,
/******/ 			"push-numbers/style-index": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["push-numbers/style-index"], () => (__webpack_require__("./src/push-numbers/index.js")))
