...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./block.json */ "./src/push-our-services/block.json");
...
function Edit({
  ...
  //Inner block
  const cardTemplate = [['push-blocks/push-our-services-inner', {}]];
  const ALLOWED_BLOCKS = ['push-blocks/push-our-services-inner'];
...
/***/ "./src/push-our-services/index.js":
/*!****************************************!*\
  !*** ./src/push-our-services/index.js ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @wordpress/block-editor */ "@wordpress/block-editor");
/* harmony import */ var _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./style.scss */ "./src/push-our-services/style.scss");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./edit */ "./src/push-our-services/edit.js");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./block.json */ "./src/push-our-services/block.json");
...
/***/ "./src/push-our-services/style.scss":
/*!******************************************!*\
  !*** ./src/push-our-services/style.scss ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/push-our-services/block.json":
/*!******************************************!*\
  !*** ./src/push-our-services/block.json ***!
  \******************************************/
/***/ ((module) => {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"push-blocks/push-our-services","version":"0.1.0","title":"Наші сервіси","icon":"admin-tools","category":"yuna-block-category","description":"Наші сервіси","example":{},"attributes":{"anchorId":{"type":"string"},"topIndent":{"enum":["indent-top-big","indent-top-small"],"default":"indent-top-big","type":"string"},"bottomIndent":{"enum":["indent-bottom-big","indent-bottom-small"],"default":"indent-bottom-big","type":"string"},"blockTitle":{"type":"string"}},"supports":{"color":{"background":true,"text":true,"heading":true,"gradients":true},"html":false},"textdomain":"push","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css","render":"file:./render.php","viewScript":"file:./view.js"}');
...
/******/ 		var installedChunks = {
/******/ 			"push-our-services/index": 0,
/******/ 			"push-our-services/style-index": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["push-our-services/style-index"], () => (__webpack_require__("./src/push-our-services/index.js")))
