...
import { PanelBody, TextControl, SelectControl, RangeControl, Notice} from '@wordpress/components';
...
export default function Edit({ attributes, setAttributes }) {
	...
	const { blockTitle, limit, anchorId, topIndent, bottomIndent} = attributes;
			...
			<InspectorControls>
				...
				<PanelBody title={'Instagram'}  >
					...
					<Notice status="info" isDismissible={ false }>
						{ 'Токен і IG User ID беруться зі сторінки опцій' }
					</Notice>
				</PanelBody>
			</InspectorControls>
