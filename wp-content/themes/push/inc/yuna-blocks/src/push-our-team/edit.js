...
export default function Edit({ attributes, setAttributes }) {
	...
	const { blockTitle, companyChiefName, companyChiefPost, chiefPhotoUrl, chiefPhotoId, slogan, blockText, anchorId, topIndent, bottomIndent } = attributes;
	...
	//Inner block
	const cardTemplate = [
		['push-blocks/push-our-team-inner',{}]
	];
				...
				<div className="container">
					<div className="row">
						...
						<RichText
							...
							onChange={ (value)=>setAttributes({ companyChiefName: value })}
							allowedFormats={ [ 'core/text-color' ] }
						/>
						<RichText
							tagName="p"
							...
							onChange={ (value)=>setAttributes({ companyChiefPost: value })}
							allowedFormats={ [ 'core/text-color' ] }
						/>

						<div className="image-block">
							{chiefPhotoUrl ? (
								<img src={chiefPhotoUrl} alt="" style={{ maxWidth: '50%' }} />
							) : (
